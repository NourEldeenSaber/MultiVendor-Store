...
<x-slot:breadcrumb>
    ...
    <script type="module">
      // Import your cart module using the Vite module specifier
      import { handleQuantityChange } from 'js/cart.js'; // Update this import path based on your Vite configuration

      // Call the function that handles quantity change
      handleQuantityChange(csrf_token);
    </script>
    @endpush
